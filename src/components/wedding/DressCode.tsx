    ...
    <section className="relative px-6 py-32">
      <div className="mx-auto max-w-6xl">
        <div className="grid items-center gap-16 md:grid-cols-[1fr_1.4fr]">
          ...
          >
            <p className="text-xs uppercase tracking-[0.4em] text-rose-deep">Dress code</p>
            <h2 className="mt-4 text-5xl text-primary md:text-6xl">
              Dress in <span className="font-script text-rose">poetry</span>
            </h2>
            <p className="mt-6 leading-relaxed text-muted-foreground">
              Garden-formal. Flowing fabrics, soft tones, romantic silhouettes. Avoid white and
              black — let the palette guide you.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-3 gap-6 md:gap-8">
            {palette.map((c, i) => (
              ...
              >
                ...
                />
                <p className="mt-4 text-xs uppercase tracking-[0.3em] text-rose-deep">{c.name}</p>
              </motion.div>
            ))}
          </div>
        </div>
